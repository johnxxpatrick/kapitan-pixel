...
const Tabs= (props) => {
    ...
    return (
      ...
      <div className="tab-wrap">
        ...
        <label htmlFor="tab1">Project List</label>
        <input type="radio" id="tab2" name="tabGroup1" className="proj-tab" />
        <label htmlFor="tab2">Section Two</label>
        <input type="radio" id="tab3" name="tabGroup1" className="proj-tab" />
        <label htmlFor="tab3">Section Three</label>
