...
$(document).ready(function ($) {
    ...
    //     if (isTouch) { $('.revealOnScroll').addClass('image-container-v2'); }
    ...
    //       // Showed...
    //       $(".revealOnScroll:not(.image-container-v2)").each(function () {
    //         var $this     = $(this),
    ...
    //               $this.addClass('image-container-v2 ' + $this.data('animation'));
    ...
    //       });
    //       // Hidden...
    //      $(".revealOnScroll.image-container-v2").each(function (index) {
    //         var $this     = $(this),
    //             offsetTop = $this.offset().top;
    //         if (scrolled + win_height_padded < offsetTop) {
    //           $(this).removeClass('image-container-v2 fadeInUp flipInX lightSpeedIn')
    //         }
    //       });
    //     }
    ...
    $(".table").eq(0).removeAttr("tabindex");
})